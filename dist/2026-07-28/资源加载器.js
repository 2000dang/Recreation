 ...
 *   - preload([keys])       批量预热
 *
 * 本地测试: 把 HX_CDN_BASE 改成本地服务器地址, 或运行后调用 HX.setBase('http://localhost:8080/dist/2026-07-28')
 * ========================================================================== */
(function (global) {
  'use strict';

  /* ===== 0. 可配置 CDN 基址 (发布前替换为你的 GitHub 仓库) ===== */
  // 例: 'https://cdn.jsdelivr.net/gh/MyUser/huanxiao-resources@main/dist/2026-07-28'
  let HX_CDN_BASE = 'https://cdn.jsdelivr.net/gh/2000dang/Recreation@main/dist/2026-07-28';
