...
CONTENT = [
 ...
 ('娄琛雨', ['娄琛雨','琛雨','主任助理','前女友','情蒙雨深'],
  ...
  '【与{{user}}关系】前女友。十年前因记忆封印分手。她藏着主角「零」身份真相与被篡改记忆的关键。'
 ...
 ('姜舞', ['姜舞','姜博士','白大褂女人'],
  ...
  '【剧情】主角的主要对手，28层人体实验室主场。后期囚禁{{user}}一年余进行人格抹除。'),
 ('萧茹', ['萧茹'],
 ...
 ('陈丹娜', ['陈丹娜','丹娜','陈助理','第二助理'],
  ...
  '【剧情】主角第二名实习助理→正式助理→后期CEO。杨玉兰最强竞争对手，两人后期并列公司CEO。'
  '右腿丝袜有镰刀铁锤图案（党组织书记）。'),
 ...
 ('孟雅雯', ['孟雅雯','雅雯','人力资源部','同居'],
  ...
  '【剧情】与主角有复杂亲密关系，后期加入三人同居（与陈丹娜、主角共同居住）。'),
