...
CONTENT = [
 ...
 ('赵加莹', ['赵加莹','加莹','赵总监','总监助理'],
  ...
  '【剧情】角色弧线最完整的配角之一。张鹏远心腹，张鹏远自杀后不幸落入公司地下交易市场，被某位高管买走作为私人坐骑。'
  '有常驻剧本「女性领导力的崛起」。'),
 ('姜舞', ['姜舞','姜博士','白大褂女人'],
 ...
 ('蒋冬·完整档案', ['蒋冬','蒋哥','副组长','竞争对手','张雪'],
  '研发部副组长→组长，{{user}}早期同组竞争对手。性格圆滑世故，善于利用助理关系获取信息。与一位组长助理有暧昧关系，通过张雪牵线接触郑航圈子。助理：刘子娴（正式助理）、张雪（实习→正式助理）。'),
 ('郑航', ['郑航','郑组长','{{user}}上级','秦燕霞上司'],
  '研发部组长，{{user}}第一任直接上级。助理：秦燕霞（组长助理）、陈娇（正式助理）。与秦燕霞有复杂暧昧关系，在剧本失控事件中受伤断臂。'),
 ('江天炜', ['江天炜','总裁','董事长','最高领导','度假村轮奸'],
  '公司前总裁/最高层，分管行政人力运营副总监，催眠剧本编写者。编写和管理公司剧本系统，曾在度假村对女员工实施侵犯。对公司女助理进行各种改造。后期离职。'),
