...
CONTENT = [
 ...
 ('圣权修女会（组织全貌）', ['圣权修女会','修女会','Sisterhood','姐妹会','组织全貌','极端女性主义','推翻男权','Y染色体','基因改造病毒','肢体再生术','世界大战筹备','千人计划'],
  ...
  '·妙妘：外勤，省城特工\n'
  '·江天炜：D级内勤（埋入公司高层）\n'
  '【陵东势力】渗透各级政府与网警。安全屋：城中村二层小楼、市郊废弃烂尾楼。省城更大分部（距陵东三小时车程）。背后靠山：市委常委项明涵（被江潮/李志峰灭门）。\n'
  '【与公司关系】环晓科技实质是修女会脑机接口大规模人体实验场。修女会在生物基因方向的研究领先全球。江潮/李志峰的"绯迷计划"打动组织高层。\n'
  '【与玩家关系】公司是组织载体，玩家的行动受组织暗中观察。解锁高层剧情会触发组织对抗（暗杀/反制）。主角副人格Doctor"零"代号是组织内部身份。\n'
 ...
 ('助理管理·职级与编制', ['助理编制','助理配额','职级与编制','管理职数','女助理晋升','助理竞聘','女助理等级'],
  '【男性职级与可拥有助理编制表】\n'
  '| 职级 | 助理总数 | 组长/主任助理 | 正式助理 | 实习助理 | 月薪(税后) |\n'
  '| 正式员工 | 1 | 0 | 0 | 1 | 20,000元 |\n'
  '| 副组长 | 2 | 0 | 1 | 1 | 30,000元 |\n'
  '| 组长 | 6 | 1(组长助理) | 2 | 3 | 40,000元 |\n'
  '| 主任 | 22 | 3(主任助理) | 6 | 12 | 80,000元+ |\n'
  '| 副总监 | 36+ | 多 | 多 | 多 | 150,000元+ |\n'
  '| 总监 | 60-70 | 多 | 多 | 多 | 300,000元+ |\n'
  '【核心规则】\n'
  '·手动挑选实习助理：20贡献点/次；自动分配：免费\n'
  '·同级别女助理工资高于男上司（诱惑性政策）\n'
  '·女助理"组长助理"级别晋升需经部门主管审批\n'
  '·"主任助理"级别晋升需经总监级审批\n'
  '【女助理体系】\n'
  '·实习助理：蓝色OL制服+白丝袜+高跟，2万月薪，站立工作12小时不许回头\n'
  '·正式助理：蓝色制服换肉丝袜，3万，可坐下\n'
  '·组长助理：黑色职业装+肉丝+恨天高，5万\n'
  '·主任助理：高级黑色定制职业装，8万+\n'
  '·总监助理/辅骑：开裆丝袜+高马尾+狗尾肛塞+跳蛋标配\n'
  '·主骑：总监助理最高级，可被骑乘移动\n'
  '【AI叙事】\n'
  '·开局选择职级时，向导页需显示该职级对应的编制上限\n'
  '·超编购买需扣除20+贡献点+走流程\n'
  '·女助理可通过助理竞聘/年度评选升级\n'
  '·高职级女助理（主任助理及以上）默认拥有【基础保护】（5贡献点/月），低职级男性无法催眠'),
